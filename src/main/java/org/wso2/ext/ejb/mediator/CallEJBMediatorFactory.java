...
public class CallEJBMediatorFactory extends AbstractMediatorFactory {
    ...
    public Mediator createSpecificMediator(OMElement elem, Properties properties) {
        ...
        CallEJBMediator mediator = new CallEJBMediator();
        ...
        attributeValue = elem.getAttributeValue(new QName(EJBConstants.JNDI_CONFIG_REG_PATH));
        if (attributeValue != null) {
            mediator.setJndiConfigRegPath(attributeValue);
        }
